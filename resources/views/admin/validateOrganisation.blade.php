...
<div class="header bg-gradient-primary py-8 py-lg-8">
    <div class="container py-5">     
        ...
        @endif
        @if (session('failed'))
        <div class="row alert alert-danger" id="failed-messages">
                        ...
                        <div class="col-lg-7 ml-2">
                            <div class="col">
                                ...
                                <h5 class="ml-3">
                                    ...
                                    <a href="/validateOrganisationGive/{{$organisation->id}}/Accepted">
                                        <img src="{{ asset('ekka') }}/images/icons/checked.png" class="svg_img" alt="" />
                                    </a>
                                    <a href="/validateOrganisationGive/{{$organisation->id}}/Rejected" class="ec-header-btn">
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-certificate').click(function () {
            ...
            dataList.append("<img class='banner-img' src='{{asset('assets')}}/img/" + itemId + "''>'");
